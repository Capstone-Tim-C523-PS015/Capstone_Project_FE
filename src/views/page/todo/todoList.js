      ...
      <div class="flex flex-col border-2 border-r-2 border-sky-900 py-4 px-4 rounded-2xl">
                  <div class="flex flex-col px-4 gap-2">
                    <div class="flex flex-row gap-3 justify-center">
                      ...
                      <h2 class="px-6 text-sky-950 text-2xl justify-center items-center font-semibold" id="${todo.title}">${todo.title}<h2>
                    ...
                    <div class="text=md text-sky-950 p-auto" id="deskripsi" data-description="${todo.description}">
