    ...
    return `
      <div id="contentUtama" class="h-screen  relative">
        <div class="flex flex-col items-center relative justify-center">
          <div id='kalendar' class="w-full h-screen  bg-white shadow-lg target shadow-sky-400 mt-5  z-0"></div>
  ...
  async afterRender() {
    ...
    function handleEventClick(info) {
      ...
      if (
        ...
        setatus.className =
          "bg-sky-300 text-sky-900 px-3 py-1 rounded-lg font-bold";
      }
      if (
    ...
    function handleEditTodo(info) {
      ...
      document.getElementById("myTextareaPutTodo").value =
    ...
    function handleEditActivity(info) {
      ...
      document.getElementById("myTextareaPutActivity").value =
        info.event.extendedProps.description;
      document.getElementById("customDatePutActivity").value =
        formattedDateTime;
    ...
    toggle.forEach((toggle) => {
      toggle.addEventListener("change", () => {
        ...
        indicator.forEach((i) => {
          i.style.transform = isChecked ? "translateX(100%)" : "translateX(0)";

          i.classList.toggle("on", isChecked);
        });
      });
    });
    ...
    function EfekPutAcrivity() {
      // Mengganti teks button menjadi "Loading..."
      document.getElementById("buttonSubmitPutActivity").innerHTML =
        "Loading...";
